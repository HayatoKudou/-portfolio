...
// export class Details extends Main {
    ...
    xhr.setRequestHeader("${option_header_content_type}");`;
            ...
            if(method === 'API'){
                ...
                //APIオプションリセット
                    ...
                    // this.getDefaultCode('JavaScript', 'API', 'reset');
                } else {
            ...
            /*文字列操作オプション*/
                ...
                //文字列操作オプションリセット
                    ...
                    setOptionStr('');
                    //初期化
                    // this.getDefaultCode(language, method);
                }
            }
        }
        ...
        return(
            ...
            {/* <Radio name="method" value="API" onClick={() => this.getDefaultCode(language, 'API', 'reset')} option="API" state={method} />&nbsp;&nbsp;
            <Radio name="method" value="STR" onClick={() => this.getDefaultCode(language, 'STR')} option="文字列操作" state={method} /> */}
            <br />
            {method == 'API' &&
